...
```bash
git clone git@github.com:gaudiy/fandom-state-book.git
...
> このリポジトリは **private** です。Gaudiy org は **Team プラン**のため private リポジトリからの
> Pages 公開は可能ですが、**公開されたサイトの HTML 自体は URL を知っていれば誰でも閲覧可能**です
> （アクセス制御付き Pages は GitHub Enterprise Cloud が必要）。
